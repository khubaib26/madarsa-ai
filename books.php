<?php 
$cxmLevel = isset($_GET['level'])?$_GET['level'] : '1';
                        ...
                        <div class="card bg-light bg-gradient rounded-lg shadow mb-3 cxm-card-box">
                            <div class="card-body p-0">
                                <div class="text-center">
                                    <img class="img-fluid w-100 xcxm-box-img wow zoomIn" data-wow-delay="0.2s" src="<?php echo BASE_URL; ?>assets/imgs/student-detail-pic.png" alt="<?php echo WEBSITE_NAME; ?>">
                                </div>
                                <a href="<?php echo BASE_URL; ?>" class="stretched-link"><span class="d-none">Go somewhere</span></a>
                            </div>
                        </div>
                    </div>
                </div>
